    ...
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.sideMenu, { transform: [{ translateX: menuAnimation }] }]}>
        <View style={styles.profileSection}>
          ...
          <Text style={styles.profileRole}>Residente</Text>
        </View>
        ...
        <TouchableOpacity style={styles.menuItem} onPress={() => {
          navigation.navigate('HistorialResidenteScreen');
          toggleMenu();
        }}>
      ...
      <View style={styles.mainContent}>
          <TouchableOpacity 
            style={styles.button} 
            onPress={() => navigation.navigate('GenerarVisita')}
          >
            <Ionicons name="add-circle" size={24} color={colors.textLight} style={styles.buttonIcon} />
